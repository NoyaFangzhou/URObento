        ...
        <div class="row div-bg-white text-left top-buffer font-black">
            <div class="col-lg-12">
                  <ul class="nav nav-tabs">
                    <li role="presentation" class="active"><a href="manage.html" style="color:black">Menu</a></li>
            ...
            <?php
                 $sql = "SELECT * FROM UROB_Dish where restaurant_id = '$rid'";
                // echo $sql;
                $result = $conn->query($sql);
                if (mysqli_num_rows($result) > 0) {
                        ...
                        '<div class="col-lg-12 ">
                            ...
                            <form class="form-inline" action="./manageHandler.php" method="post">
                                <div class="thumbnail col-lg-2">
                                    <img src="'.$row["dish_img"].'" onerror="if (this.src != \'../img/sample.jpg\') this.src = \'../img/sample.jpg\';" alt="">
                                </div>
                                <div class="col-lg-5">
                                    <p><label>Name:</label>'.$row["dname"].'</p>
                                    <p><label>Price:</label><input type="text" class="form-control" name="dish_price" value="'.$row["dprice"].'"/></p>
                                ...
                                <input type="hidden" name="dname" value="'.$row["dname"].'">
                            </form>
                        </div>';
